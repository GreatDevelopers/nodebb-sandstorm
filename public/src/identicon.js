...
/* Replace 'identicon://<hash>' URLs with 'data:' URLs containing the image */
$(function() {
	function generateIdenticon() {
		var els = document.querySelectorAll('img[src^="identicon://"]');
	...
	generateIdenticon();
	var observer = new MutationObserver(generateIdenticon);
